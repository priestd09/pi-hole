...
installScripts() {
	...
	${SUDO} cp /etc/.pihole/advanced/Scripts/switchBranch.sh /opt/pihole/switchBranch.sh
	${SUDO} chmod 755 /opt/pihole/gravity.sh /opt/pihole/chronometer.sh /opt/pihole/whitelist.sh /opt/pihole/blacklist.sh /opt/pihole/piholeLogFlush.sh /opt/pihole/updateDashboard.sh /opt/pihole/uninstall.sh /opt/pihole/setupLCD.sh /opt/pihole/version.sh /opt/pihole/switchBranch.sh
